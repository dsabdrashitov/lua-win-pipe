...
Release v.1.2 binaries built with _mingw-w64_ for Lua 5.4: [zip][binary-lua54]

[sample-client]: sample-client.lua
[sample-server]: sample-server.lua
[binary-lua54]:https://github.com/dsabdrashitov/lua-win-pipe/releases/download/v.1.2/lua-win-pipe-v_1_2-lua54-win64.zip